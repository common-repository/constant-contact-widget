...
Plugin URI: https://membershipworks.com/constant-contact-widget-a-free-simple-and-lightweight-plugin/
Description: This plugin has been deprecated as Constant Contact will be disabling the Version 0.1 API as of Dec 6 2016.
Version: 1.9.4
...
function sf_constantcontact_error() {
	echo '<div class="notice notice-error"><p>The Constant Contact Widget plugin is deprecated and will stop working on Dec 6 2016. Please switch to a different plugin asap!</p></div>'; 
}
add_action('admin_notices','sf_constantcontact_error');
